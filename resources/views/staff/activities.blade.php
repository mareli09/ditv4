...
@section('title', 'Activities - Staff Portal')
...
<div class="card mb-4 bg-light">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('staff.activities.join-with-code') }}" class="d-flex gap-2 flex-wrap">
            @csrf
        ...
        <div class="col-md-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-footer bg-transparent d-flex gap-2">
                    <a href="{{ route('staff.activities.show', $activity->id) }}" class="btn btn-sm btn-outline-primary flex-grow-1">
