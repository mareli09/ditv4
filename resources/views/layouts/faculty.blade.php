...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Faculty Dashboard - CESO')</title>
...
<body>
    ...
    <div class="header-bar">
        ...
        <h4><i class="fas fa-chalkboard me-2" style="color: #3b82f6;"></i> Faculty Portal</h4>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <a href="{{ route('faculty.activities') }}" class="{{ request()->routeIs('faculty.activities') ? 'active' : '' }}">
            ...
            <a href="{{ route('faculty.my-activities') }}" class="{{ request()->routeIs('faculty.my-activities') ? 'active' : '' }}">
