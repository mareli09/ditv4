...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Staff Dashboard - CESO')</title>
...
<body>
    ...
    <div class="header-bar">
        ...
        <h4><i class="fas fa-briefcase me-2" style="color: #3b82f6;"></i> Staff Portal</h4>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <a href="{{ route('staff.activities') }}" class="{{ request()->routeIs('staff.activities') ? 'active' : '' }}">
            ...
            <a href="{{ route('staff.my-activities') }}" class="{{ request()->routeIs('staff.my-activities') ? 'active' : '' }}">
