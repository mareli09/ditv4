...
<div class="mb-4">
    <h3 class="fw-bold">Edit Project</h3>
    <p class="text-muted">Update project details</p>
</div>

<div class="card shadow-sm">
    <div class="card-body">
        <form action="{{ route('ceso.projects.update', $project) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="conducted_by" class="form-control @error('conducted_by') is-invalid @enderror" value="{{ old('conducted_by', $project->conducted_by) }}" required>
                @error('conducted_by')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="target_audience" class="form-control @error('target_audience') is-invalid @enderror" value="{{ old('target_audience', $project->target_audience) }}" required>
            ...
            <div class="mb-4">
                ...
                <textarea name="remarks" class="form-control" rows="3">{{ old('remarks', $project->remarks) }}</textarea>
            </div>
