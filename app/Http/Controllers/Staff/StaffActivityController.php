...
class StaffActivityController extends Controller
{
    ...
    public function joinWithCode(Request $request)
    {
        ...
        return redirect()->route('staff.activities.show', $activity->id)
                        ->with('success', 'You have successfully joined the activity!');
    }

    public function show(Activity $activity)
    {
        return view('staff.activity_details', compact('activity'));
    }
    ...
    public function myActivities()
    {
        ...
        return view('staff.my-activities', compact('activities'));
    }
}
